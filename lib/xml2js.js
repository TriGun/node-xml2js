...
(function() {
  ...
  exports.Parser = (function(_super) {
    ...
    Parser.prototype.typingValue = function(newValue) {
      if ((Number(newValue) || Number(newValue) === 0) && String(Number(newValue)) === newValue) {
    ...
    Parser.prototype.assignOrPush = function(obj, key, newValue) {
      ...
      if (this.options.typing) {
        newValue = this.typingValue(newValue);
      }
      if (key === 'text' || key === 'text_sig') {
        newValue = encodeURIComponent(unescape(newValue));
      }
      if (key === 'color' || key === 'c') {
        newValue = this.options.colorPalette[newValue];
      }
      if (key === 'controlPoints') {
        newValue = newValue.split(',').map(function(a) {
          return Number(a);
        });
      }
      if (key === 'image_id') {
      ...
      if (!(key in obj)) {
        if (this.options.explicitArray || key === 'obj' || key === 'page' || key === 'crv') {
          if (key === 'page') {
            obj[key] = {};
            return obj[key]['p' + newValue.id] = newValue;
          } else {
        ...
        return function(node) {
          ...
          if (!_this.options.ignoreAttrs) {
            ...
            for (key in _ref) {
              ...
              if (_this.options.typing) {
                newValue = _this.typingValue(newValue);
              }
